...
Windows 桌面常驻待办贴纸：小窗口贴在桌面一角，日 / 周视图联动，未完成任务跨日自动流转，多台电脑通过你自己的 Git 仓库同步。当前版本 **0.8.6**。
...
| 文件 | 说明 |
| --- | --- |
| `rike-0.8.6-x64-setup.exe` | NSIS 安装包（推荐） |
| `rike-0.8.6-x64-portable.exe` | 便携版，下载后直接运行 |
